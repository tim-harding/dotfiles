vim.lsp.enable {
    'dartls', 'zls', 'ocamllsp', 'pyright', 'ruby_lsp', 'gopls', 'biome',
    'cssls', 'jsonls', 'html', 'shopify_theme_ls', 'glsl_analyzer', 'clangd',
    'tinymist', 'nixd', 'hyprls', 'svelte', 'vtsls', 'volar', 'sourcekit',
    'lua_ls', 'hls', 'metals', 'omnisharp', 'cls'
}
    ...
    callback = function(event)
        ...
        if client:supports_method('textDocument/documentHighlight', bufnr) then
            ...
            vim.api.nvim_create_autocmd('LspDetach', {
                group = vim.api
                    .nvim_create_augroup('lsp-detach', {clear = true}),
